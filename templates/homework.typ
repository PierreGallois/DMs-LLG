#let dm(
  ...
  show heading.where(level: 3): set heading(numbering: (..nums) => str.from-unicode("a".to-unicode() - 1 + nums.at(-1)) + ")")
  
  show heading.where(level: 4): set heading(numbering: (..nums) => numbering("i.", nums.at(-1)))
